  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 20, alignItems: 'start' }}>
        ...
        {/* ===== KOLOM KIRI: Tracking + Riwayat + Kondisi Sepatu ===== */}
        ...
        {/* ===== KOLOM KANAN: Detail + Informasi + Bayar + Review ===== */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {order.payment ? (
            order.payment.status === 'PAID' ? (
              <div id="nota-cetak" style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 16, padding: 24 }}>
              ...
              <div style={{ background: '#fffbeb', border: '1px solid #fcd34d', borderRadius: 16, padding: '16px 20px', fontSize: 13, color: '#92400e', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
